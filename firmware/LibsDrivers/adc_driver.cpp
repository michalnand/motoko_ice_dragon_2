...
void ADC_driver::init()
{
    ...
    Gpio<'B', 1, GPIO_MODE_AN>   ir_front_left;
    Gpio<'B', 0, GPIO_MODE_AN>   ir_left;
    Gpio<'C', 1, GPIO_MODE_AN>   ir_right;
    Gpio<'C', 0, GPIO_MODE_AN>   ir_front_right;
    ...
    adc_channels[8]  = ADC_IR_FRONT_LEFT;
    adc_channels[9]  = ADC_IR_LEFT;
    adc_channels[10] = ADC_IR_RIGHT;
    adc_channels[11] = ADC_IR_FRONT_RIGHT;
...
// call ADC data processing when all channels scan done
