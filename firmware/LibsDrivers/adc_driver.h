...
#define ADC_IR_FRONT_LEFT           (LL_ADC_CHANNEL_9)    //PB1
#define ADC_IR_LEFT                 (LL_ADC_CHANNEL_8)    //PB0
#define ADC_IR_RIGHT                (LL_ADC_CHANNEL_11)   //PC1
#define ADC_IR_FRONT_RIGHT          (LL_ADC_CHANNEL_10)   //PC0
